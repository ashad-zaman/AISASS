...
let AdminController = class AdminController {
    ...
    async getFailedDocuments(limit) {
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get system stats (admin only)' }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], AdminController.prototype, "getStats", null);
__decorate([
    (0, common_1.Get)('failed-documents'),
    (0, swagger_1.ApiOperation)({ summary: 'Get failed documents' }),
    __param(0, (0, common_1.Query)('limit')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", Promise)
], AdminController.prototype, "getFailedDocuments", null);
__decorate([
